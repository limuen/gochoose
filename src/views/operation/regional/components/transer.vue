<template>
  <div class="transer-container">
    <div class="create-button">
      <el-button type="primary" @click="handleCreate" icon="el-icon-edit">添加停车点</el-button>
    </div>
    ...
    <!-- 添加修改停车点 -->
    <el-dialog :title="dialogtitle" class="transerform" :visible.sync="dialogForm">
      <el-row :gutter="24">
        <el-form :model="form">
          <el-col :span="12">
            <div class="grid-content bg-purple">
          ...
          <el-col :span="12">
            <div class="grid-content bg-purple">
              <el-form-item label="运营区域" :label-width="formLabelWidth">
                <el-select v-model="form.region" placeholder="请选择运营区域">
                  <el-option label="区域一" value="shanghai"></el-option>
                  <el-option label="区域二" value="beijing"></el-option>
                </el-select>
              </el-form-item>
          ...
          <el-col :span="12">
            <div class="grid-content bg-purple">
              <el-form-item label="车辆点名称" :label-width="formLabelWidth">
                <el-input v-model="form.name" autocomplete="off"></el-input>
              </el-form-item>
            </div>
          </el-col>
          <el-col :span="24">
            <div class="grid-content bg-purple">
              <el-form-item label="区域配置说明：" class="bg-size-color" :label-width="formLabelWidth">
                <ol>
                  <li>停车点必须设置在红色运营区域内,点击地点后，将以此地点形成个10*10米的圆形停车点。</li>
...
.transer-container .search-container /deep/ .el-input {
  width: 195px;
}
.transer-container /deep/ .page-container{
