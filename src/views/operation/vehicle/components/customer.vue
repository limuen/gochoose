<template>
  <div class="customer-container">
    <div class="create-button">
        <el-button type="primary" @click="handleCreate" icon="el-icon-edit">新建工单</el-button>
    </div>
    <div class="search-container">
      <el-row :gutter="24">
        ...
        <el-col :span="6">
          <div class="grid-content bg-purple">
            <span>指派给</span>
            <el-input v-model="value" placeholder="请输入至少两个关键字"></el-input>
          </div>
        </el-col>
        <el-col :span="6">
          <div class="grid-content bg-purple">
    ...
    <!-- 新建客服工单 -->
    <el-dialog title="新建客服工单" width="35%" :visible.sync="dialogcustormer">
      <el-form :model="form" class="customer">
        <el-form-item label="车辆编号" :label-width="formLabelWidth">
          <el-input v-model="form.name" disabled autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="指派给" :label-width="formLabelWidth">
          <el-select v-model="form.region" placeholder="请选择活动区域">
            <el-option label="区域一" value="shanghai"></el-option>
            <el-option label="区域二" value="beijing"></el-option>
          </el-select>
      ...
      <div slot="footer" class="dialog-footer" align="center">
        <el-button @click="dialogcustormer = false">取 消</el-button>
        <el-button type="primary" @click="dialogcustormer = false">确 定</el-button>
      </div>
    </el-dialog>
...
.customer-container .search-container /deep/ .el-input {
  width: 195px;
}
.customer-container .Operation /deep/ .el-input,.el-textarea,.customer-container .customer /deep/ .el-input,.el-textarea{
  width: 300px;
}
