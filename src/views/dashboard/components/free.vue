<template>
  <div class="Rideout">
    ...
    <el-table :data="tableData" border style="width: 100%">
      ...
      <el-table-column prop="date" align="center" label="空闲时常"></el-table-column>
      <el-table-column prop="name" align="center" label="电量"></el-table-column>
      <el-table-column prop="address" align="center" label="续航里程"></el-table-column>
...
.Rideout .Operation /deep/ .el-input,
.Rideout .Operation /deep/ .el-textarea {
  width: 200px;
}
</style>