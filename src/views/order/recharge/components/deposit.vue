        ...
        >
          ...
          <el-table-column label="操作" align="center" width="100" fixed="right">
            <template slot-scope="scope">
              <el-button
                type="primary"
                v-permission="button.recharge_recharge_deposit_rouse"
...
.deposit-container .search-container /deep/ .el-input {
  width: 230px;
}
.deposit-container .form /deep/ .el-input {
  width: 350px;
}
</style>