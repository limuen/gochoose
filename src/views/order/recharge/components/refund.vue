      ...
      <el-row :gutter="24">
        <el-col :span="6">
          <div class="grid-content bg-purple">
            <span>退款类型</span>
            <el-select v-model="value" placeholder="请选择退款类型">
              <el-option
        ...
        <el-col :span="6">
          <div class="grid-content bg-purple">
            <span>退款渠道</span>
            <el-select v-model="value" placeholder="请选择退款渠道">
              <el-option
                v-for="item in options"
                :key="item.value"
                :label="item.label"
        ...
        <el-col :span="6">
          <div class="grid-content bg-purple">
            <span>退款操作人</span>
            <el-select v-model="value" placeholder="请选择退款操作人">
              <el-option
                v-for="item in options"
                :key="item.value"
                :label="item.label"
        ...
        <el-col :span="6">
          <div class="grid-content bg-purple">
            <span>退款单号</span>
            <el-input v-model="value" placeholder="请输入退款单号"></el-input>
          </div>
        </el-col>
        <el-col :span="18">
          <div class="grid-content bg-purple">
