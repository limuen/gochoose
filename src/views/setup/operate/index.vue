  ...
  <div class="permission-container">
    <div class="permission-content">
      <div class="permission-search">
        <div>
          <el-input v-model="query.name" placeholder="请输入姓名" style="width:200px;"></el-input>
          <el-input v-model="query.phone" placeholder="请输入手机号" style="width:200px;"></el-input>
          <el-select v-model="query.createName" clearable filterable placeholder="请选择角色">
            <el-option
        ...
        <div>
          <el-button plain @click="handleCancel"  style="margin-right:10px">导出</el-button>
          <router-link to="/setup/operate/create">
            <el-button type="primary" icon="el-icon-plus">添加运营人员</el-button>
          </router-link>
        </div>
      </div>
        ...
        >
          ...
          <el-table-column label="操作" align="center" width="180">
            <template slot-scope="scope">
              <el-button type="text">
                <router-link
                  :to="{ path:'/setup/operate/edit', query: { id: scope.row.name } }"
                >编辑</router-link>
              </el-button>
